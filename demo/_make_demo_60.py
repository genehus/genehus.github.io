...
NARRATION = (
    ...
    "African men face among the highest prostate-cancer mortality, and often present late. "
    "Hospitals still triage mainly on P-S-A and clinical judgement. "
    "GeneHus ranks who to see first by combining routine clinical inputs with an African "
    "genomic signal — while the doctor stays in the loop. "
    "This hospital preview uses sample cases only. Not for clinical use. "
    "Patients are ranked by combined risk. Late presentations rise to the top. "
    "A modest P-S-A with a genomic flag shows why P-S-A alone is not enough. "
    "Clinicians can enter a new sample case — age, P-S-A, Gleason, stage, family history, "
    "and a sample African genomic profile — then update the preview. "
    "Honest status: working v-one is not built yet. No real patients. Not validated. "
    "Not Ghana F-D-A approved. Nearest milestone: M-A-D-C-a-P permission, then v-one, "
    "then a hospital check versus P-S-A alone. "
